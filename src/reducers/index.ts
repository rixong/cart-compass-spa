/* 
User Reducer - id, email, pw, [Lists: only ListIds]

Lists - [Lists with id, name, isCurrent, createdAt, items[itemId, ]]

SystemState Reducer - notification, loading, curUser, isLoggedIn, 

Categories Reducer - [Categories]

ItemsMasterList Reducer - [Items]
*/
